...
export const VOCAB_CARD_REVIEW_VOCAB_LABEL = "Vocab";
export const VOCAB_CARD_REVIEW_VOCAB_STR =
VOCAB_CARD_REVIEW_VOCAB_LABEL.toLowerCase();
export const VOCAB_CARD_REVIEW_DEHET_LABEL = "DeHet";
